 ...
 */
public class JoinLeagueAdapter extends ArrayAdapter {
    ...
    public JoinLeagueAdapter(Context context, int resource){
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        if (row==null){
            ...
            row = layoutInflater.inflate(R.layout.join_leagues_layout,parent,false);
            ...
            final Button openLeague = (Button)row.findViewById(R.id.open_bn);
            openLeague.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    class joinLeague extends AsyncTask<String,Void,String>
                    {
                        ...
                        protected String doInBackground(String... params){
                            ...
                            try{
                                ...
                                URL url = new URL(json_url+"?uid="+uid+"&lid="+lid);
                        ...
                        protected void onPostExecute(String result) {
                            ...
                            if(json_string==null){
                                ...
                                //openLeague.setText("Joined");
                                openLeague.setBackgroundResource(R.drawable.open_league_button_layout);
                                openLeague.setClickable(false);
                                openLeague.setText("Joined");
                                //openLeague.setVisibility(View.INVISIBLE);
                    ...
                    new joinLeague().execute(playerHolder.userid.getText().toString());
